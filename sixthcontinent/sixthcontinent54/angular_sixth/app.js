...
app.controller('AppController', ['$cookieStore', '$rootScope', 'ipCookie','$scope', '$location', '$translate', '$timeout', 'UserService', 'ProfileService', 'TranslationService', 'TopLinkService', '$compile', '$window', 'verifyUser',
    ...
    var img = new Image();
	//Add variable to store the user
	if( !localStorage.getItem('loggedInUser') || !localStorage.getItem('access_token')) {
		...
		APP.accessToken = localStorage.getItem('access_token');
		$rootScope.currentUser = JSON.parse(localStorage.getItem('loggedInUser'));
		var opts = {};
...
app.config(['$routeProvider', '$httpProvider', '$locationProvider', function($routeProvider, $httpProvider, $locationProvider) {
	...
	$routeProvider
		...
		.when('/shop/wallet/:shopId/pending/payment', {
			templateUrl:'app/views/redirect_user.html',
			controller: 'PendingPaymentFromNoti'
		})
