    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
        function(fileUploaderOptions, $rootScope, $http, $window, $compile) {
            ...
            FileUploader.prototype._xhrTransport = function(item) {
                ...
                form.append(item.formDataName, item._file);
                form.append(item.dataObjName, angular.toJson(item.data));
                var that = this;
            ...
            function FileItem(uploader, some, options) {
                ...
                angular.extend(this, {
                    ...
                    data: uploader.data,
                    formDataName: uploader.formDataName,
                    dataObjName: uploader.dataObjName
                }, options, {
                    uploader: uploader,
