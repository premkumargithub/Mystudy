...
function playFun(element) {
 
    $(element).prev().children().show();
    $(element).prev().prev().children().hide();
    $(element).parent().addClass('displayplay');
    $(element).parent().next().addClass('displayvideocontent');
    $(element).hide();
}
...
(function($) {
    ...
    $.fn.linkPreview = function(options) {
        ...
        $(this).append('<div id="previewLoading_'+selector+'" class="previewLoading"></div> <div> <textarea type="text" autocomplete="off" autocorrect="off" id="text_'+selector+'" placeholder="'+opts.placeholder+'"/></textarea> <div style="clear: both"></div> </div> <div id="preview_'+selector+'" class="preview"> <div id="previewImages_'+selector+'" class="previewImages"> <div id="previewImage_'+selector+'" class="previewImage"><img src="app/assets/images/proceed.gif" style="margin-left: 43%; margin-top: 39%;"/> </div><div id="videoiframe"></div> <div id="playbutton" onclick="playFun(this)"><a href="javascript:void(0)"><i class="fa fa-play"></i></a></div> <input type="hidden" id="photoNumber_'+selector+'" class="photoNumber" value="0" /> </div> <div id="previewContent_'+selector+'" class="previewContent"> <div id="closePreview_'+selector+'" title="Remove" class="closePreview" ></div> <div id="previewTitle_'+selector+'" class="previewTitle"></div> <div id="previewUrl_'+selector+'" class="previewUrl"></div> <div id="previewDescription_'+selector+'" class="previewDescription"></div> <div id="hiddenDescription_'+selector+'" class="hiddenDescription"></div> <div id="previewButtons_'+selector+'" class="previewButtons" > <div id="previewPreviousImg_'+selector+'" class="buttonLeftDeactive" ></div> <div id="previewNextImg_'+selector+'" class="buttonRightDeactive" ></div> <div id="photoNumbers_'+selector+'" class="photoNumbers" ></div> <div id="chooseThumbnail_'+selector+'" class="chooseThumbnail"> Choose a thumbnail </div> </div> <div class="nT" id="nT_'+selector+'" > <span id="noThumbDiv_'+selector+'" class="noThumbDiv" ><input type="checkbox" id="noThumb_'+selector+'" class="noThumb noThumbCb" />  No thumbnail</span> </div> </div> <div style="clear: both"></div> </div> <div style="clear: both"></div> <div id="postPreview_'+selector+'" class="postPreview"> </div> <div class="previewPostedList" id="previewPostedList_'+selector+'"></div>');
        var text;
        ...
        $('#text_'+selector).keyup(function(e) {
            ...
            if ((e.which === 13 || e.which === 32 || e.which === 17 || e.which === 91) && trim($(this).val()) !== "") {
                ...
                if (block === false && urlRegex.test(text)) {
                    ...
                    $('#postbtn_'+selector).hide();
                    $('#photoNumber_'+selector).val(0);

                    allowPosting = false;
                    isCrawling = true;

                    $.post('php_view/textCrawler.php', {
                        text : text,
                        ...
                        //video iframe
                        if(answer.video == "yes") {
                            $('#playbutton').html('<a href="javascript:void(0)"><i class="fa fa-play"></i></a>');                          
                            $('#videoiframe').html(answer.videoIframe);  
                            $('#playbutton').css('height', '100%');
                        } else {
                            $('#videoiframe').html('');
                            $('#playbutton').html('');
        ...
        $('#postPreviewButton_'+selector).click(function() {
            ...
            if (((trim(text) !== "") || (trim(text) === "" && trim(hrefUrl) !== "")) && (allowPosting === true && isCrawling === false)) {
                $.get('php_view/highlightUrls.php', {
                    text : text,
